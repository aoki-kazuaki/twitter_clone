...
from app.repositories.auth_token_repository import (
    auth_token_find_refresh_token_by_refresh_token_uuid,
    auth_token_find_valid_refresh_token_by_refresh_token_uuid,
    auth_token_insert_refresh_token,
    auth_token_revoke_refresh_token_by_user_uuid,
)
...
class TestAuthTokenRepository:
    ...
    def test_insert_refresh_token_success(self):
        auth_token_insert_refresh_token(self.refresh_token_uuid, self.user_uuid, self.expires_at, get_test_connection)

        result = auth_token_find_valid_refresh_token_by_refresh_token_uuid(self.refresh_token_uuid, get_test_connection)
    ...
    def test_revoke_refresh_token_by_user_uuid_success(self):
        ...
        auth_token_revoke_refresh_token_by_user_uuid(self.user_uuid, get_test_connection)
    ...
    def test_find_auth_refresh_token_by_refresh_token_uuid_success(self):
        ...
        result = auth_token_find_refresh_token_by_refresh_token_uuid(self.refresh_token_uuid, get_test_connection)
    ...
    def test_find_auth_refresh_token_by_refresh_token_uuid_result_none(self):
        ...
        result = auth_token_find_refresh_token_by_refresh_token_uuid(invalid_refresh_token_uuid, get_test_connection)
